...
DATA: CONTRACT_SCREEN_MODE TYPE C LENGTH 4 VALUE '0140'.
...
CONTROLS: CTRPRV_TABLE_CONTROL TYPE TABLEVIEW USING SCREEN 0149.
CONTROLS: CTRSER_TABLE_CONTROL TYPE TABLEVIEW USING SCREEN 0149.
*&---------------------------------------------------------------------*
*& Selection Screen
*&---------------------------------------------------------------------*
