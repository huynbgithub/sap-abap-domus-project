...
IF SY-SUBRC = 0.
  ...
  LOOP AT T_PCKIMG INTO DATA(S_PCKIMG).

    S_PCKIMG-CREATED_BY = 'DEVELOPER'.
    S_PCKIMG-CREATED_AT = '093026'.
    S_PCKIMG-CREATED_ON = '20240702'.

    MODIFY T_PCKIMG FROM S_PCKIMG  INDEX SY-TABIX.
