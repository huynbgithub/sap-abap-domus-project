...
IF SY-SUBRC = 0.
  ...
  LOOP AT T_PRODCT INTO DATA(S_ROW).
    ...
    CONCATENATE S_ROW-PRODUCT_NAME 'from the brand' FIRST_WORD 'has multiple characteristics including' REST_OF_NAME
                 ...
                 'Its efficiency and effectiveness are enhanced. The brand ' FIRST_WORD
    'Advanced features are implemented that not only meet but exceed consumer expectations. Whether it’s for personal or professional use, this product is versatile and adaptable.'
                 ...
                 'Whether you are seeking reliability, efficiency, or cutting-edge performance, this product promises to deliver outstanding results in every use.'
                 'Welcome our customers to discover the excellence of the'
                 S_ROW-PRODUCT_NAME INTO S_ROW-DESCRIPTION SEPARATED BY SPACE.
    CONCATENATE S_ROW-DESCRIPTION '.' INTO S_ROW-DESCRIPTION.
