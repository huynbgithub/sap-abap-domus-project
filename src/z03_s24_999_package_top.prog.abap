...
DATA: GT_PCKPRV TYPE STANDARD TABLE OF TY_PCKPRV WITH EMPTY KEY.
DATA: GT_PCKPRV_BEFORE_MOD TYPE STANDARD TABLE OF TY_PCKPRV WITH EMPTY KEY.
DATA: GT_PCKPRV_DELETED TYPE STANDARD TABLE OF TY_PCKPRV WITH EMPTY KEY.
