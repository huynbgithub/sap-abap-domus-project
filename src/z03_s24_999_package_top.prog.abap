...
DATA: GT_PCKPRV TYPE STANDARD TABLE OF TY_PCKPRV WITH KEY PACKAGE_ID PRODUCT_VARIANT_ID.
DATA: GT_PCKPRV_BEFORE_MOD TYPE STANDARD TABLE OF TY_PCKPRV WITH KEY PACKAGE_ID PRODUCT_VARIANT_ID.
DATA: GT_PCKPRV_DELETED TYPE STANDARD TABLE OF TY_PCKPRV WITH KEY PACKAGE_ID PRODUCT_VARIANT_ID.

DATA: GS_PCKSER TYPE TY_PCKSER.
DATA: GT_PCKSER TYPE STANDARD TABLE OF TY_PCKSER WITH KEY PACKAGE_ID SERVICE_ID.
DATA: GT_PCKSER_BEFORE_MOD TYPE STANDARD TABLE OF TY_PCKSER WITH KEY PACKAGE_ID SERVICE_ID.
DATA: GT_PCKSER_DELETED TYPE STANDARD TABLE OF TY_PCKSER WITH KEY PACKAGE_ID SERVICE_ID.
...
DATA: GT_PCKIMG TYPE STANDARD TABLE OF TY_PCKIMG.
DATA: GT_PCKIMG_BEFORE_MOD TYPE STANDARD TABLE OF TY_PCKIMG.
DATA: GT_PCKIMG_DELETED TYPE STANDARD TABLE OF TY_PCKIMG.
