...
FORM PROCESS_QUO_DISPLAY_CHANGE .
  CASE GV_QUOTATION_SCREEN_MODE.
    WHEN GC_QUOTATION_MODE_DISPLAY.
      IF GS_QUOTATION_DETAIL-STATUS = 'Requested' OR GS_QUOTATION_DETAIL-STATUS = 'Negotiating' OR
         GS_QUOTATION_DETAIL-STATUS = 'REQUESTED' OR GS_QUOTATION_DETAIL-STATUS = 'NEGOTIATING'.
        GV_QUOTATION_SCREEN_MODE = GC_QUOTATION_MODE_CHANGE.
      ELSEIF GS_QUOTATION_DETAIL-STATUS = 'Accepted' OR
             GS_QUOTATION_DETAIL-STATUS = 'ACCEPTED'.
