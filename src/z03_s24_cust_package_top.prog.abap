...
CLASS CL_PRODUCT_ALV_HANDLER DEFINITION.
  PUBLIC SECTION.
...
DATA: O_PRODUCT_0120_CONTAINER TYPE REF TO CL_GUI_CUSTOM_CONTAINER,
      ...
      O_PRODUCT_0120_HANDLER   TYPE REF TO CL_PRODUCT_ALV_HANDLER.
...
DATA: GT_PCKPRV_AFTER_MOD TYPE STANDARD TABLE OF TY_PCKPRV WITH KEY ID PACKAGE_ID PRODUCT_VARIANT_ID.
...
DATA: GT_PCKSER_AFTER_MOD TYPE STANDARD TABLE OF TY_PCKSER WITH KEY ID PACKAGE_ID SERVICE_ID.
...
*Table controls in Screen 0170
CONTROLS: PCKPRV_TABLE_CONTROL_0170 TYPE TABLEVIEW USING SCREEN 0170.
CONTROLS: PCKSER_TABLE_CONTROL_0170 TYPE TABLEVIEW USING SCREEN 0170.
